...
namespace OVM
{
	...
	*/
	...
	private:
		...
		typedef std::map<LessArray<unsigned int>, int> OppFaceContainer;
	//-----------------------------------------------------------------------------------------------------------------
	public:
	...
	protected:
		/** resize */
		void vertices_resize(unsigned int _n);
		/** resize */
		void half_edges_resize(unsigned int _n);
		/** resize */
		void half_faces_resize(unsigned int _n);
		/** resize */
		void hedrons_resize(unsigned int _n);
		/** reserve */
		void vertices_reserve(unsigned int _n);
		/** rese */
		void half_edges_reserve(unsigned int _n);
		/** reserve */
		void half_faces_reserve(unsigned int _n);
		/** reserve */
		void hedrons_reserve(unsigned int _n);
		/** swap two vertices */
	...
	public:
		...
		unsigned int n_half_edges()const
		{
			return half_edges_.size();
		}
		unsigned int n_half_faces() const
		{
			return half_faces_.size();
		}
		unsigned int n_hedrons() const
		{
	...
	private:
		...
		unsigned int re_v_status_;
		unsigned int re_he_status_;
		unsigned int re_hf_status_;		
		unsigned int re_h_status_;
	protected:
		//unsigned int kernel_type_;      /**< the type of the kernel, 0x0001 for tetrahedron, 0x0002 for hexahedron */
