...
//---------------------------------------------------------------------------------------------------------------------
	...
	*/
	...
	public:
		...
		*/
		VertexHandle find_vertex_handle(const Point & _p) const
		{
			...
			for (ConstVertexIter cv_it = vertices_begin(); cv_it != vertices_end(); ++ cv_it )
			{
				if (point(cv_it) == _p)
				{
					return VertexHandle(cv_it - vertices_begin());
				}				
			}			
	...
	public:
		...
		int half_face_region(ConstHalfFaceIter & _hf_it) const;
	//-----------------------------------------------------------------------------------------------------------------
	public:
