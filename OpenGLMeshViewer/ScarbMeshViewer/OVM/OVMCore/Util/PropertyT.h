...
//---------------------------------------------------------------------------------------------------------------------
	...
	public:
		...
		PropertyT(const PropertyT<T> & _rhs) : BaseProperty(_rhs), data_(_rhs.data_)
		{
		}
		virtual ~ PropertyT()
		{
	...
	public:
		virtual void reserve(unsigned int _n) 
		{
			data_.reserve(_n);
		}
		virtual void resize(unsigned int _n)
		{
			data_.resize(_n);
		}
		virtual void clear()
		...
		virtual void swap(unsigned int _i0, unsigned int _i1)
		{
			std::swap(data_[_i0], data_[_i1]);
		}
	public:
		/** return the size of the data */
		virtual unsigned int n_elements()
		{
			return data_.size();
		}
		virtual unsigned int element_size()
		{
		...
		{
			assert((unsigned int)(_idx) < data_.size());
			return data_[_idx];
		}
