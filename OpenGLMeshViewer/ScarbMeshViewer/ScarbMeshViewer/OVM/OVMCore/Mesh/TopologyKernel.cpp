...
//---------------------------------------------------------------------------------------------------------------------
	...
	*/
	...
	/** resize */
	void TopologyKernel::vertices_resize(unsigned int _n)
	{
		vertices_.resize(_n);
	}
	/** resize */
	void TopologyKernel::half_edges_resize(unsigned int _n)
	{
		half_edges_.resize(_n);
	}
	/** resize */
	void TopologyKernel::half_faces_resize(unsigned int _n)
	{
		half_faces_.resize(_n);
	}
	/** resize */
	void TopologyKernel::hedrons_resize(unsigned int _n)
	{
		hedrons_.resize(_n);
	}
	/** reserve*/
	void TopologyKernel::vertices_reserve(unsigned int _n)
	{
		vertices_.reserve(_n);
	}
	/** reserve */
	void TopologyKernel::half_edges_reserve(unsigned int _n)
	{
		half_edges_.reserve(_n);
	}
	/** reserve */
	void TopologyKernel::half_faces_reserve(unsigned int _n)
	{
		half_faces_.reserve(_n);
	}
	/** reserve */
	void TopologyKernel::hedrons_reserve(unsigned int _n)
	{
		hedrons_.reserve(_n);
	}
	/** swap two vertices */
