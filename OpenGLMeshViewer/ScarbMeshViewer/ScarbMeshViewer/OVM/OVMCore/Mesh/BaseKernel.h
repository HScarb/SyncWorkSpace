...
//---------------------------------------------------------------------------------------------------------------------
	...
	public:
		...
		unsigned int _add_v_property(BaseProperty * _bp)
		{
			return v_properties_._add(_bp);
		}
		unsigned int _add_he_property(BaseProperty * _bp)
		{
			return he_properties_._add(_bp);
		}
		unsigned int _add_hf_property(BaseProperty * _bp)
		{
			return hf_properties_._add(_bp);
		}
		unsigned int _add_h_property(BaseProperty * _bp)
		{
			return h_properties_._add(_bp);
		}


		BaseProperty & _v_property(unsigned int  _idx)
		{
			return v_properties_._property(_idx);
		}
		BaseProperty & _he_property(unsigned int _idx)
		{
			return v_properties_._property(_idx);
		}
		BaseProperty & _hf_property(unsigned int _idx)
		{
			return v_properties_._property(_idx);
		}
		BaseProperty & _h_property(unsigned int _idx)
		{
			return v_properties_._property(_idx);
		}
		const BaseProperty & _v_property(unsigned int _idx) const
		{
			return v_properties_._property(_idx);
		}
		const BaseProperty & _he_property(unsigned int _idx) const
		{
			return v_properties_._property(_idx);
		}
		const BaseProperty & _hf_property(unsigned int _idx) const
		{
			return v_properties_._property(_idx);
		}
		const BaseProperty & _h_property(unsigned int _idx) const
		{
			return v_properties_._property(_idx);
		}
	protected:
	...
	protected:
		void v_properties_reserve(unsigned int _n) const
		{
			v_properties_.reserve(_n);
		}
		void v_properties_resize(unsigned int _n) const
		{
		...
		void v_properties_swap(unsigned int _i0, unsigned int _i1) const
		{
			v_properties_.swap(_i0, _i1);
		}

		void he_properties_reserve(unsigned int _n) const
		{
			he_properties_.reserve(_n);
		}
		void he_properties_resize(unsigned int _n) const
		{
		...
		void he_properties_swap(unsigned int _i0, unsigned int _i1) const
		{
			he_properties_.swap(_i0, _i1);
		}
		void hf_properties_reserve(unsigned int _n) const
		{
			hf_properties_.reserve(_n);
		}
		void hf_properties_resize(unsigned int _n) const
		{
		...
		void hf_properties_swap(unsigned int _i0, unsigned int _i1) const
		{
			hf_properties_.swap(_i0, _i1);
		}
		void h_properties_reserve(unsigned int _n) const
		{
			h_properties_.reserve(_n);
		}
		void h_properties_resize(unsigned int _n) const
		{
		...
		void h_properties_swap(unsigned int _i0, unsigned int _i1) const
		{
	...
	public:
		...
		virtual unsigned int n_half_edges()const
		{
			return 0;
		}
		virtual unsigned int n_half_faces() const
		{
			return 0;
		}
		virtual unsigned int n_hedrons() const
		{
			return 0;
		}
	//-----------------------------------------------------------------------------------------------------------------
	public:
		unsigned int n_v_properties() const
		{
			return v_properties_.size();
		}
		unsigned int n_he_properties() const
		{
			return he_properties_.size();
		}
		unsigned int n_hf_properties() const
		{
			return hf_properties_.size();
		}
		unsigned int n_h_properties() const
		{
