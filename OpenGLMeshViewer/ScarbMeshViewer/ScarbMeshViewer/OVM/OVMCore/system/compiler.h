...
#ifndef _OVM_COMPILER_H_
#define _OVM_COMPILER_H_

//---------------------------------------------------------------------------------------------------------------------

#if defined(MAKE_STATIC_BUILD)
...
#  endif
#  define OVM_USE_INTEL_COMPILER 1
#endif
...
// .NET 2003 1310
// .NET 2005 1400
#if defined(_MSC_VER) && !defined(OVM_USE_INTEL_COMPILER)
#  if (_MSC_VER == 1300)
#    define OVM_CC_MSVC
#    define OVM_TYPENAME
...
#    define OVM_INCLUDE_TEMPLATES           1
#  else
#    error "Version 8 (.NET 2005) or higher of the MS VC++ is required!"
#  endif
...
#  endif
#  define OVM_CC "ICC"
#  define OVM_CC_VERSION __INTEL_COMPILER
//   currently no windows dll supported
...
#  define OVM_CC "MIPS"
#  define OVM_CC_VERSION _COMPILER_VERSION
...
//---------------------------------------------------------------------------------------------------------------------
#endif // _OVM_MESH_COMPILER_H_ defined
